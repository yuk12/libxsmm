...
#define _mm512_store_fil(A,B)  _mm256_stream_si256((__m256i*)(A), _mm512_cvtneps_pbh((B)))
...
typedef struct my_fc_bwd_config {
  ...
  libxsmm_bmmfunction_reducebatch_strd_meltwfused gemm_upd4;
